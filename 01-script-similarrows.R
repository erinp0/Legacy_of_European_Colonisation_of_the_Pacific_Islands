...
B = matrix(
  c(0.5, 0.2, 0.2, 0.1, 0, 0, 0, 0, 0, 0,
    0.4, 0.3, 0.3, 0, 0, 0, 0, 0, 0, 0,
    0.5, 0, 0.2, 0.1, 0.1, 0, 0, 0, 0, 0),nrow=3,ncol=10,byrow=T)+0.05
B=B/rowSums(B)
...
TernaryPoints(pars[c("f[1]", "f[2]","f[3]")] , col='black', pch=20, cex=0.5)
